...
class DeActiveOrders extends StatelessWidget {
  final List<Order> finishedOrder;
  const DeActiveOrders({super.key, required this.finishedOrder});
      ...
      child: GestureDetector(
        ...
        child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              final List<Order> reversedList = finishedOrder.reversed.toList();
